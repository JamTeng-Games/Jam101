...
namespace xasset.editor
{
	public static class GroupAssetsMenuItems
	{
		...
		[MenuItem("Assets/Group To/TestBuild/G1")]
		private static void GroupToTestBuildG1()
		{
			Settings.MakeSelectionAssetsGroupTo("TestBuild", "G1");
			Debug.Log("Group to G1 with build TestBuild.");
		}
	}
}
