...
namespace Jam.Core
{
    ...
    public struct GFLinkedListRange<T> : IEnumerable<T>, IEnumerable
    {
        ...
        public GFLinkedListRange(LinkedListNode<T> first, LinkedListNode<T> terminal)
        {
        ...
        {
            private readonly GFLinkedListRange<T> _mGfLinkedListRange;
            private LinkedListNode<T> m_Current;
            private T m_CurrentValue;

            internal Enumerator(GFLinkedListRange<T> range)
            {
                if (!range.IsValid)
                {
                    throw new Exception("Range is invalid.");
                ...
                _mGfLinkedListRange = range;
                m_Current = _mGfLinkedListRange.m_First;
            ...
            {
                if (m_Current == null || m_Current == _mGfLinkedListRange.m_Terminal)
                {
                    return false;
                }
